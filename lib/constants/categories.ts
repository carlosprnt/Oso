...
export const CATEGORIES: CategoryMeta[] = [
  ...
  { value: 'productivity', label: 'Productivity', icon: Zap,       color: 'bg-teal-100',   textColor: 'text-teal-800'   },
  { value: 'cloud',        label: 'Cloud',        icon: Cloud,     color: 'bg-slate-100',  textColor: 'text-slate-800'  },
