...
export function Skeleton({ className = '' }: SkeletonProps) {
  return (
    <div
      className={`animate-pulse bg-[#F5F5F5] rounded-xl ${className}`}
    />
  )
}

export function SkeletonText({ className = '' }: SkeletonProps) {
  return <div className={`animate-pulse bg-[#F5F5F5] rounded-md h-4 ${className}`} />
}

// Matches the wide Monthly+Yearly card
export function SkeletonStatWide({ className = '' }: SkeletonProps) {
  return (
    <div className={`bg-white rounded-2xl border border-[#E8E8E8] p-5 ${className}`}>
      <div className="animate-pulse grid grid-cols-2">
        <div className="pr-5 border-r border-[#F0F0F0] space-y-3">
          <div className="h-3 bg-[#F5F5F5] rounded-md w-16" />
          <div className="h-8 bg-[#F5F5F5] rounded-lg w-28" />
...
export function SkeletonStatSmall({ className = '' }: SkeletonProps) {
  return (
    <div className={`bg-white rounded-2xl border border-[#E8E8E8] p-4 ${className}`}>
      <div className="animate-pulse space-y-2.5">
        <div className="h-3 bg-[#F5F5F5] rounded-md w-12" />
        <div className="h-7 bg-[#F5F5F5] rounded-lg w-20" />
        <div className="h-3 bg-[#F5F5F5] rounded-md w-16" />
      </div>
    </div>
  )
