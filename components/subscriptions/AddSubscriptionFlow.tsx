  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 px-4 h-12 rounded-2xl bg-[#121212] text-white text-sm font-medium hover:bg-[#000000] transition-colors pressable"
      >
        <Plus size={15} />
        {t('common.add')}
      </button>
        ...
        footer={
          ...
          >
            <button
              ...
              className="flex-1 h-12 rounded-full text-sm font-semibold text-[#121212] dark:text-[#F2F2F7] border border-[#121212] dark:border-[#F2F2F7] bg-transparent flex items-center justify-center active:bg-[#FFFFFF] dark:active:bg-[#2C2C2E] transition-colors"
            >
              {t('picker.searchGmail')}
            </button>
            <button
              onClick={() => handleSelect(null)}
              className="flex-1 h-12 rounded-full text-sm font-semibold text-white bg-[#121212] flex items-center justify-center active:bg-[#000000] transition-colors"
            >
