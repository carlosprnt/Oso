  ...
  const content = (
    ...
    >
      ...
      >
        ...
        <div aria-hidden className="hidden dark:block" style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 360, background: brandTint.gradientDark, opacity: 0.45, pointerEvents: 'none', zIndex: 0 }} />
